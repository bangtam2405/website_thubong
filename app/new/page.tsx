...
export default function NewProductsPage() {
  ...
  useEffect(() => {
    axios.get("http://localhost:5000/api/products?type=new")
  ...
  return (
    <div className="container mx-auto py-12 px-4">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-4">Sản Phẩm Mới</h1>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Khám phá những sản phẩm thú nhồi bông mới nhất của chúng tôi. Cập nhật thường xuyên với những thiết kế độc đáo và đáng yêu nhất!
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        {!loading && newItems.length === 0 && (
          <div className="col-span-full text-center text-gray-400">Chưa có sản phẩm mới nào.</div>
        )}
        {newItems.map((item) => (
          <Card key={item._id} className="overflow-hidden group">
            <div className="relative">
              ...
              <Badge className="absolute bottom-2 left-2 bg-green-500 text-white">Mới</Badge>
            </div>
